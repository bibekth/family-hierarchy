...
<body
    ...
    <div class="w-full transition-opacity opacity-100 duration-750 lg:grow">
        ...
        <form id="filter-form" class="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4 p-4 rounded">
            ...
            <input type="date" name="dob" placeholder="Date of Birth" title="Date of Birth"
                class="px-4 py-2 rounded border border-gray-300 dark:bg-gray-900 dark:text-white">
    ...
    @if (Route::has('login'))
        <div class="fixed bottom-0 left-0 w-full bg-white dark:bg-[#1b1b18] z-50 px-4 py-2">
            <div class="flex flex-col md:flex-row justify-center md:justify-end flex-wrap gap-2 text-sm">
...
<script>
    ...
    form.addEventListener('input', () => {
        ...
        debounceTimer = setTimeout(() => {
            window.removeEventListener('scroll', scrollHandler); // reset scroll
            loadMore(true);
