            ...
            <div class="">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <span>{{ __('People you have added.') }}</span><span><a
                                href="{{ route('hierarchy.create') }}"><button class="btn btn-sm btn-primary">Add
                                    New</button></a></span></div>
                                            ...
                                            <div class="d-flex gap-1">
                                                <a href="{{ route('hierarchy.edit', $item->id) }}">
                                                    <button class="btn btn-sm btn-secondary"
                                                        onclick="return confirm('Are you sure?')">Edit</button>
                                                </a>
